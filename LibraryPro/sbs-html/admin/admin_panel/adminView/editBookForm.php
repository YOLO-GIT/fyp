    ...
    ?>
            <form id="update-Items" onsubmit="updateBook()" enctype='multipart/form-data'>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="qty" value="<?= $row1['book_title'] ?>" >
                </div>
                <div class="form-group">
                    <label for="qty">Update ISBN Number:</label>
                    <input type="text" class="form-control" id="isbn" value="<?= $row1['book_ISBN'] ?>" >
                </div>
                <div class="form-group">
                    <label for="author">Update Author:</label>
                    <input type="text" class="form-control" id="author" value="<?= $row1['book_author'] ?>" >
                </div>
                <div class="form-group">
                    <label for="publish">Update Publisher:</label>
                    <input type="text" class="form-control" id="publish" value="<?= $row1['publisher'] ?>" >
                </div>
                <div class="form-group">
                    <label for="publish">Update Calling Number:</label>
                    <input type="text" class="form-control" id="dewey" value="<?= $row1['book_dewey'] ?>" >
                </div>
                <div class="form-group">
                    <label for="publish">Update Book's Description:</label>
                    <input type="text" class="form-control" id="desc" value="<?= $row1['book_desc'] ?>" >
                </div>
                <div class="form-group">
                    <label for="category">Update Book's Category:</label>
                    <select name="cbokategori" class="form-control" id="category" >
                ...
                <div class="form-group">
                    ...
                    <select name="cbolanguage" class="form-control" id="language" >
                ...
                <div class="form-group">
                    ...
                    <select name="cboillustrasi" class="form-control" id="illustration" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="info1" value="<?= $row1['book_matter1'] ?>" >
                </div>
                <div class="form-group">
                    <label for="info2">Update Book's Info 2:</label>
                    <input type="text" class="form-control" id="info2" value="<?= $row1['book_matter2'] ?>" >
                </div>
                <div class="form-group">
                    <label for="info3">Update Book's Info 3:</label>
                    <input type="text" class="form-control" id="info3" value="<?= $row1['book_matter3'] ?>" >
                </div>
                <div class="form-group">
                    <label for="condition">Update Book's Condition:</label>
                    <select name="cboillustrasi" class="form-control" id="condition" >
