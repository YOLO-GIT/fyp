                ...
                <div class="col-md-12">
                    <form name="frmregisteration" class="main_form_reg" action="register_proses.php" method="get" onsubmit="return validated()">
                        ...
                        <div class="row">
                            ...
                            <!-- EMAIL -->
                            <div class="col-md-6">
                                <label class="custom_label_reg">Email Anda*, E.g.: user123@gmail.com:</label>
                                <div id="email_error" class="form-control">Tolong Isi Email Anda Dengan Betul</div>
                                <input class="contactus" placeholder="Email*" type="text" name="txtEmail" autocomplete="off" required>
                            </div>
                            <!-- PASSWORD -->
                            <div class="col-md-12">
                                ...
                                <input class="contactus" placeholder="Password (Maksimum 9 nombor/perkataan)*" type="password" name="txtpwd" id="myInputPWD" maxlength="9" pattern=".{9,}" autocomplete="off" required>
                                <input type="checkbox" onclick="myFunction()">&nbsp;&nbsp;<label class="show_style">Show Password</label>
                            </div>
                            <!-- SUBMIT -->
                            <div class="col-md-12">
                                <button type="submit" class="send_btn1" name="cmdteacherregister">Register</button>
                            </div>
                        </div>
                    </form>
                </div>
