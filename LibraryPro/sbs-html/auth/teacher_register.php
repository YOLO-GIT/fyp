...
<body class="main-layout inner_page">
        ...
        <div class="container">
            <div class="row custom-background-reg">
                <div class="row">
                    ...
                    <div class="main_form_reg col-md-6">
                        <a href="register_proses.php"><button type="submit" class="btn btn_user">Teacher</button></a>
                    </div>
                </div>
                <div class="col-md-12">
                    <form name="frmregisterationT" class="main_form_reg" action="register_proses.php" method="get" onsubmit="return validated()">
                        <br><br>
                        <div class="row">
                            <!-- IC -->
                            <div class="col-md-12">
                                <label class="custom_label_reg">Nombor IC*: IC Anda tanpa "-"</label>
                                <div id="ic_error" class="form-control">TTolong Isi IC Anda Dengan Betul (Letak Nombor Sahaja)</div>
                            ...
                            <!-- EMAIL -->
                            <div class="col-md-6">
                                <label class="custom_label_reg">Email Anda*, E.g.: g-12345678@moe-dl.edu.my:</label>
                            ...
                            <div class="col-md-12 mt-5 mb-5">
                                <button type="submit" class="btn_reg" name="cmdteacherregister">Register</button>
                            </div>
                        </div>
                    </form>
                    <div class="col-md-12">
    ...
    <!-- Custom JS -->
    <script src="../js/validation_teacher.js"></script>
    <script>
        AOS.init();
    </script>
</body>
