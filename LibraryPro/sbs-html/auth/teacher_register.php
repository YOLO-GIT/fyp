    ...
    <div class="register_body">
        ...
        <div class="container">
            <div class="row custom-background-reg">
                ...
                <div class="col-md-12">
                    <form name="frmregisterationT" class="main_form_reg" action="register_proses.php" method="post" onsubmit="return validated()">
                        <br><br>
                        <div class="row">
                            <!-- IC -->
                            <div class="col-md-12">
                                <label class="custom_label_reg">IC Number*: Your IC without "-"</label>
                            ...
                            <!-- EMAIL -->
                            <div class="col-md-6">
                                <label class="custom_label_reg">Your email*, E.g.: g-12345678@moe-dl.edu.my:</label>
