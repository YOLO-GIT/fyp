    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (isset($_POST['cmdupdate'])) {
            ...
            if (mysqli_num_rows($check_password) > 0) {
                ...
                echo "<script>alert('The password already has been used.');</script>";
                ...
                if ($confirmPassword != $newPassword) {
                    ...
                    $update_stud_password = "UPDATE tblstudent SET stud_pwd = '$newPassword', reset_token = 'xxx' WHERE reset_token = '$token'";
        ...
        if (isset($_POST['cmdupdate'])) {
            ...
            if (mysqli_num_rows($check_password) > 0) {
                ...
                if ($confirmPassword != $newPassword) {
                    ...
                    $update_teachers_password = "UPDATE tblteachers SET teachers_Password = '$newPassword', reset_token = 'xxx' WHERE reset_token = '$token'";
