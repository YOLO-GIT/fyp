...
if (isset($_POST["cmdreset"])) {
    ...
    $check_stud_query = "SELECT * FROM tblstudent WHERE stud_ID = '$user_ID' AND email = '$email'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $updateTokenQuery = "UPDATE `tblstudent` SET reset_token = '$resetToken' WHERE stud_ID = '$user_ID' AND email = '$email'";
